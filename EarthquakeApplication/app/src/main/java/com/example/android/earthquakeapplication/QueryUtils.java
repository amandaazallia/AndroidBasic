...
public final class QueryUtils {
    ...
    public static ArrayList<Earthquake> extractEarthquakes() {
        ...
        try {
            ...
            //buat dapetin features
            JSONArray earthquakeArray = baseJsonResponse.getJSONArray("features");

            for ( int i = 0; i < earthquakeArray.length(); i++){
                JSONObject currentEarthquake = earthquakeArray.getJSONObject(i);

                //buat dapetin properties dari features
                ...
                Earthquake earthquake = new Earthquake(magnitude, location, timeInMilliseconds, url); //pemanggilan key dari features harus dibuat method baru yang nantinya bisa di return di akhir

                earthquakes.add(earthquake); //akhir dari parse features yang tinggal di return dibawah
            }
